...
function widget_sidebarlogin($args) {
		...
		if (isset($user_ID)) {
			...
			echo '<ul class="pagenav">
					<li class="page_item">Use the power of the people. Write something!</a></li>
					<li class="page_item"><a href="'.get_bloginfo('wpurl').'">'.__('Post it now?').'</a></li>
					<li class="page_item"><a href="'.get_bloginfo('wpurl').'/tag-archive">'.__('Tag archive').'</a></li>
